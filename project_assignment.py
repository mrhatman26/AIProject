...
column_num = 0
row_num = 0
#This for loop goes through each column listed in column_list and then goes through each row and add its value to a list.
...
os.system("mkdir -p Model") #Creates the directory "Model" in the same directory as this python file if the directory does not already exist.
knn_pickle = open('jobs_model', 'wb') #Opens or creates job_model.
